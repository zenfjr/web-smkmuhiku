                        ...
                        <div class="form-group col-md-3 col-3 mt-0 ml-5">
                          ...
                          <div class="form-group col-md-3 col-3 mt-0 ml-5">
                            ...
                            <div class="selectgroup w-100">
                              ...
                              <label class="selectgroup-item">
                                <input type="radio" name="jurusan" value="TBSM" class="selectgroup-input"  {{$id->jurusan=='TBSM' ? 'checked=""' : ''}}>
                                <span class="selectgroup-button">TBSM</span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="jurusan" value="TAV" class="selectgroup-input" {{$id->jurusan=='TAV' ? 'checked=""' : ''}}>
                                <span class="selectgroup-button">TAV</span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="jurusan" value="AKL" class="selectgroup-input" {{$id->jurusan=='AKL' ? 'checked=""' : ''}}>
                                <span class="selectgroup-button">AKL</span>
                              </label>
