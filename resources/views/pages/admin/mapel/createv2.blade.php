                    ...
                    <div class="row col-12">
                      ...
                      <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        <div class="selectgroup w-100">
                          ...
                          <label class="selectgroup-item">
                            <input type="radio" name="jurusan" value="TBSM" class="selectgroup-input" >
                            <span class="selectgroup-button">TBSM</span>
                          </label>
                          <label class="selectgroup-item">
                            <input type="radio" name="jurusan" value="TAV" class="selectgroup-input">
                            <span class="selectgroup-button">TAV</span>
                          </label>
                          <label class="selectgroup-item">
                            <input type="radio" name="jurusan" value="AKL" class="selectgroup-input">
