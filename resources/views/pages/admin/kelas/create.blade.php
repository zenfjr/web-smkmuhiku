            ...
            <div class="card-body">
                ...
                <form action="{{route('kelas.store')}}" method="post">
                    ...
                    <div class="form-group col-md-3 col-3 mt-0 ml-5">
                      ...
                      <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                          <input type="radio" name="jurusan" value="TBSM" class="selectgroup-input" checked="">
                          <span class="selectgroup-button">TBSM</span>
                        </label>
                        <label class="selectgroup-item">
                          <input type="radio" name="jurusan" value="TAV" class="selectgroup-input"checked="">
                          <span class="selectgroup-button">TAV</span>
                        </label>
                        <label class="selectgroup-item">
                          <input type="radio" name="jurusan" value="AKL" class="selectgroup-input"checked="">
