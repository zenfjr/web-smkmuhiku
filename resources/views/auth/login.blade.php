...
<head>
  ...
  <title>{{ config('app.name', 'SMK Muhiku') }}</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="../assets/img/logosmk.png" alt="logo" width="100">
            </div>



            <div class="card card-primary">
              <div class="card-header text-center"><h4>SISTEM INFOMASI MANAJEMEN SMK MUHIKU</h4>
              </div>
